...
namespace pav.DataAcessLayer
{
    class DataManager
    {
        ...
        public DataManager()
        {
            ...
            //var string_conexion = @"Data Source=cx\sqlexpress;Initial Catalog=BD8.3;Integrated Security=True";
            var string_conexion = @"Data Source=DESKTOP-P2IGMAU\SQLEXPRESS;Integrated Security=SSPI;Initial Catalog=BD8.42";
