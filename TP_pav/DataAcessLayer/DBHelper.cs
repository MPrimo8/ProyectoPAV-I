...
namespace pav.DataAcessLayer
{
    class DBHelper
    {
        ...
        private DBHelper()
        {
            ...
            //string_conexion = @"Data Source=cx\sqlexpress;Initial Catalog=BD8.3;Integrated Security=True";
            string_conexion = @"Data Source=DESKTOP-P2IGMAU\SQLEXPRESS;Integrated Security=SSPI;Initial Catalog=BD8.42";
        }
